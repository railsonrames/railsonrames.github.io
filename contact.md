...
layout: page
title: Contato
description: Fala que eu te escuto, no caso leio
permalink: /contact/
---
...
<div class="container">
  ...
  <h2>Fala que eu te escuto, no caso leio</h2>
  ...
  <div id="form" class="contact-form">
    <form accept-charset="UTF-8" method="POST" action="https://formspree.io/{{ site.email }}" v-on:submit.prevent="validateBeforeSubmit" ref="contact">
      <fieldset>
        <input type="hidden" name="_subject" value="Nova mensagem recebida do seu site tunado!" />
        ...
        <textarea name="message" onkeyup="adjust_textarea(this)" placeholder="Diga me tudo" v-validate="'required'"
